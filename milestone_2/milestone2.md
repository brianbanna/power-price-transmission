...
![Landing frame of the prototype, introducing the five-country canvas, title reveal, and scroll cue.](figures/fig_01_hero.png)
...
| 4 | Year in one view. Calendar heatmap of every hour in 2024–2025 for DE and CH, toggleable. | Canvas heatmap, 13,140 cells per country. |
...
![Step 3 hero frame: the price shock peak at 13:00, Switzerland at -€145.12, flow arrows from Germany.](figures/fig_02_step3_peak.png)

![Step 4: calendar heatmap, DE-CH tab toggle, full eighteen-month window.](figures/fig_03_heatmap.png)

![Step 5: generation stack for Germany on 12 May 2024, with price line and load.](figures/fig_04_genstack.png)

![Step 7: five-country small multiples, shared daily shape, different intensities.](figures/fig_05_smallmults.png)
